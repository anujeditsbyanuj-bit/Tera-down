...
if __name__ == "__main__":
    ...
    try:
        # initialize & start uploader clients before running main app
        try:
            loop.run_until_complete(init_uploader_clients())
        except Exception as e:
        ...
        try:
            # stop uploader clients
            loop.run_until_complete(stop_uploader_clients())
